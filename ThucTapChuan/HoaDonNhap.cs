...
namespace ThucTapChuan
{
    public partial class formHoaDonNhap : Form
    {
        ...
        private void btThem_Click(object sender, EventArgs e)
        {
            ...
            string queryHD = "insert into HoaDon_NhapHang(MaHD_NhapHang, MaNV, NgayHD_NhapHang, MaNCC) " +
                             "values ('" + txtMaHD.Text + "', '" + txtMaNV.Text + "', '" +
                             DateTime.Parse(txtNgayNhap.Text).ToString("yyyy-MM-dd") + "', '" + txtMaNCC.Text + "')";

            string queryCHD = "insert into ChiTiet_NhapHang(MaSP, MaHD_NhapHang, SoLuong, TongTien) " +
                              "values ('" + txtMaSP.Text + "', '" + txtMaHD.Text + "', '" + txtSoLuong.Text + "', '" + txtTongTien.Text + "')";
